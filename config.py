...
DEFAULT_RATINGS_DEFINITIONS = [
    {"rating": 1,
     "value": "Trivial: A small gain for a small area.",
     "interest": "Averse: Visceral disgust.",
     "effort": "Unconscious: I can do this automatically."},
    {"rating": 2,
     "value": "Insignificant: A modest gain for a small area.",
     "interest": "Unappealing: Strong, steady distaste.",
     "effort": "Easy: Only a few simple steps."},
    {"rating": 3,
     "value": "Minor: A big gain for a small area.",
     "interest": "Reluctant: I'd rather not do this.",
     "effort": "Straightforward: Many simple steps."},
    {"rating": 4,
     "value": "Helpful: A small gain for a big area.",
     "interest": "Tolerable: Faint but detectable resistance.",
     "effort": "Moderate: Many steps, but some are difficult."},
    {"rating": 5,
     "value": "Solid: A modest gain for a big area.",
     "interest": "Indifferent: No strong feels either way.",
     "effort": "Difficult: Just beyond my current abilities."},
    {"rating": 6,
     "value": "Significant: A big gain for a big area.",
     "interest": "Curious: Seems fun, but my interest may expire.",
     "effort": "Demanding: Modestly beyond my current abilities. Growth required."},
    {"rating": 7,
     "value": "Strategic: A foundation for many future projects.",
     "interest": "Eager: A strong, consistent pull.",
     "effort":  "Arduous: Well beyond my current abilities. Significant growth required."},
    {"rating": 8,
     "value": "Fundamental: Essential to my life and identity.",
     "interest": "Invested: I would pick this over other things I enjoy.",
     "effort": "Daunting: Astronomical scale, complexity, and uncertainty."},
    {"rating": 9,
     "value": "Transformative: Expected to reshape my worldview or capabilities entirely.",
     "interest": "Magnetic: On my mind all the time; postponing work is actively painful.",
     "effort": "Ambitious: Borderline impossible. High risk of failure. But others have done it."},
    {"rating": 10,
     "value": "Spiritual: My life's work; a source of purpose and meaning.",
     "interest": "Calling: There is nothing I would rather do.",
