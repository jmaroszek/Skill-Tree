...
Python 3.13, Dash + Dash Bootstrap Components (DARKLY theme), Dash Cytoscape, NetworkX, NumPy, SciPy, Plotly, SQLite via stdlib `sqlite3`. No bundler — JS in `assets/` is served raw.
