...
sidebar_content = html.Div(
    [
        ...
        dbc.Form([
            ...
            dbc.Button("New Node", id="btn-new-node", color="secondary", outline=True, className="w-100 mt-2",
                       style={"padding": "8px 0"}),
            dbc.Tooltip("Delete this node", target="btn-delete", placement="top",
                        delay={"show": TOOLTIP_SHOW_DELAY_MS, "hide": TOOLTIP_HIDE_DELAY_MS}),
            dbc.Tooltip("Clear this node's data", target="btn-cancel", placement="top",
                        delay={"show": TOOLTIP_SHOW_DELAY_MS, "hide": TOOLTIP_HIDE_DELAY_MS}),
